<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Leave.aspx.vb" Inherits="WEBMIS.Leave" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img id="employeePhoto" src="" alt="Employee Photo" class="img-fluid" />
                </div>
            </div>
        </div>
    </div>
