<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Liquidations.aspx.vb" Inherits="WEBMIS.Liquidations" %>
...
<head>
    ...
    <title>Liquidation Approval</title>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped mt-4">
                        <Columns>
                            ...
                            <asp:BoundField DataField="LiquidationNo" HeaderText="Liquidation No" />
                            <asp:BoundField DataField="CashadvanceNo" HeaderText="Cash Advance No" />
                            <asp:BoundField DataField="TotalAmount" HeaderText="Total Amount" />
                            <asp:BoundField DataField="TotalExcess" HeaderText="Total Excess" />
                            <asp:BoundField DataField="Fullname" HeaderText="FullName" />
                            <asp:BoundField DataField="DateLiquidated" HeaderText="Date Liquidated" DataFormatString="{0:MM/dd/yyyy}" />
                            <asp:BoundField DataField="Remarks" HeaderText="Remarks" />
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Button ID="btnView" runat="server" Text="View" CssClass="btn btn-info" CommandArgument='<%# Eval("LiquidationNo") %>' OnClick="btnView_Click" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
