...
Public Class OBT
    ...
    Private Sub BindGridLeave(Status_1 As String, Status_2 As String, Status_3 As String)
        gDT = ExecuteQuery("exec [HRIS2].dbo.HRIS_Approval2 'OBT','" & gEmployeeID & "','" & Groupings & "','" & Status_1 & "','" & Status_2 & "','" & Status_3 & "'")
    ...
    Protected Sub btnView_Click(sender As Object, e As EventArgs)
        ...
        Dim OBT As String = button.CommandArgument
        ' Get image data from database
        Dim imageData As Byte() = GetImageDataFromDatabase(OBT)
