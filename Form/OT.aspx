<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OT.aspx.vb" Inherits="WEBMIS.OT" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>OT Approval</title>
        ...
        <form id="form1" runat="server">
            <div class="container mt-4">
                       ...
                       <h2>OT Approval</h2>
                            ...
                            <asp:TemplateField>
                                  <ItemTemplate>
                                    <asp:Button ID="btnView" runat="server" Text="View" CssClass="btn btn-info" 
                                        CommandArgument='<%# Eval("OT No.") %>' OnClick="btnView_Click" />
                                 </ItemTemplate>
                            </asp:TemplateField>
                        <asp:BoundField DataField="Employee ID" HeaderText="Employee ID" />
                        <asp:BoundField DataField="Full Name" HeaderText="Full Name" />
                        <asp:BoundField DataField="OT No." HeaderText="OT Number" />
                        <asp:BoundField DataField="Date OT" HeaderText="Date OT" DataFormatString="{0:MM/dd/yyyy}" />
                        <asp:BoundField DataField="TimeFrom" HeaderText="Time From" />
                        <asp:BoundField DataField="TimeTo" HeaderText="Time To" DataFormatString="{0:MM/dd/yyyy}" />
                        <asp:BoundField DataField="NTime" HeaderText="NDays" />
                        ...
                        <asp:BoundField DataField="Section: Date" HeaderText="S ection: Date" />
